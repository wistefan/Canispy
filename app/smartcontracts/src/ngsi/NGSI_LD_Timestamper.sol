...
contract NGSI_LD_Timestamper {
    ...
    event EntityCreation(uint256 indexed id_hash, uint256 indexed value_hash);
    event EntityDeletionById(uint256 indexed id_hash, uint256 indexed value_hash);
